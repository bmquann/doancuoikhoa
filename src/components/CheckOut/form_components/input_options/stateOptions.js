...
class stateOptions extends React.Component {
    render() {
		var handleSetState = this.props.handleSetState;
		return (
			<Input onChange={(e)=>{handleSetState(e.target.value)}}  className="custom-select" type="select" name="state" id="coState">
				...
				<option data-code="VN" value="Virginia">VietNam</option>
