...
class countryOptions extends React.Component {
    render() {
      var handleSetCountry = this.props.handleSetCountry;
		return (
			<Input onChange={(e)=>{handleSetCountry(e.target.value)}} className="custom-select" type="select" name="country" id="coCountry">
